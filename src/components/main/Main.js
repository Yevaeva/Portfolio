...
const Main = () => {
    ...
    const expressions = ['Developer', 'Programmer', 'Coder','Problem Solver', 'Creator'];
    ...
    useEffect(() => {
        ...
        }, (reverse ? 70 : subIndex === expressions[index].length ? 1000 :
            150));
    ...
    return (
            ...
            <p>
            The  {expressions[index].substring(0, subIndex)}<span>|</span> 
            </p>
            </div>
            <button >
